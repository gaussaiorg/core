# Bootstrappable Gaussai Core Builds

This directory contains the files necessary to perform bootstrappable Gaussai
Core builds.
...
To build Gaussai Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Gaussai Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/gaussai-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/gaussaipay/guix.sigs).
...
[guix-docker]: https://github.com/gaussaiorg/tree/master/contrib/guix/Dockerfile
