...
Arguments:
    <base_directory> - The base directory of a Gaussai Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Gaussai Core developers'
...
Arguments:
    <base_directory> - The base directory of Gaussai Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Gaussai Core repository.
"""
