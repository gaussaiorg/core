...
Setup
---------
Configuring the github-merge tool for the Gaussai Core repository is done in the following way:

    git config githubmerge.repository gaussaipay/gaussai
...
A script to optimize png files in the gaussai
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_gaussai: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_gaussai: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_gaussai: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_gaussai: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
