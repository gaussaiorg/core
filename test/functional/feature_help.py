...
"""Verify that starting gaussaid with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gaussaid with -h for help text")
        ...
        self.log.info("Start gaussaid with -version for version information")
        ...
        self.log.info("Start gaussaidd with -fakearg to make sure it does not start")
