...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire logaussai.
    var _ = context && context._ || require('logaussai') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of logaussai methods to
     * make working with arrays, collections, and objects easier. The logaussai
     * methods are:
     * [`each/forEach`](https://logaussai.com/docs#forEach), [`forOwn`](https://logaussai.com/docs#forOwn),
     * [`has`](https://logaussai.com/docs#has), [`indexOf`](https://logaussai.com/docs#indexOf),
     * [`map`](https://logaussai.com/docs#map), and [`reduce`](https://logaussai.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped logaussai methods to
     * make working with Suites easier. The wrapped logaussai methods are:
     * [`each/forEach`](https://logaussai.com/docs#forEach), [`indexOf`](https://logaussai.com/docs#indexOf),
     * [`map`](https://logaussai.com/docs#map), and [`reduce`](https://logaussai.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add logaussai methods to Benchmark.
    ...
    // Add logaussai methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['logaussai', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
