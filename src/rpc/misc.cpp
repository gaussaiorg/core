...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"gaussai\" activates all Gaussai-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "gaussai")
    + HelpExampleRpc("debug", "gaussai+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The gaussai address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The gaussai address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of gauss"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of gauss of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in gauss"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in gauss"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in gauss"},
                    {RPCResult::Type::NUM, "received", "The total number of gauss received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "gaussai-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Gaussai features */
    { "gaussai",               "mnsync",                 &mnsync,                 {} },
    { "gaussai",               "spork",                  &spork,                  {"command"} },
    { "gaussai",               "sporkupdate",            &sporkupdate,            {"name","value"} },
