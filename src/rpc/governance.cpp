...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 GSS irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on gaussaicentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* Gaussai features */
    { "gaussai",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "gaussai",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "gaussai",               "gobject",                &gobject,                {} },
    { "gaussai",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
