...
/** Utility functions used by the Gaussai Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gaussai:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load gaussai specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a gaussai specific theme is activated (light/dark).*/
