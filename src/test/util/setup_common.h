...
/* Initialize Gaussai-specific components after chainstate initialization */
void GaussaiTestSetup(NodeContext& node);
void GaussaiTestSetupClose(NodeContext& node);
