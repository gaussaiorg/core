...
//! Interface for the src/evo part of a gaussai node (gaussaid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a gaussai node (gaussaid process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a gaussai node (gaussaid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a gaussai node (gaussaid process).
...
//! Top-level interface for a gaussai node (gaussaid process).
class Node
{
public:
    virtual ~Node() {}
