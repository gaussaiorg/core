 ...
 *  We have 4 times smaller block times in Gaussai, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Gaussai Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // GSS this code also handles non-TXs (Gaussai specific messages)
