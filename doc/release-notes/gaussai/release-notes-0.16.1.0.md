...
- Starting Gaussai Core compiled without wallet support or with `-disablewallet` command line
...
See detailed [set of changes](https://github.com/gaussaiorg/compare/v0.16.0.1...gaussaipay:v0.16.1.0).

- [`b1c930bc86`](https://github.com/gaussaiorg/commit/b1c930bc86) [v0.16.x] bump version in configure.ac (#3788)
- [`3d94e714a9`](https://github.com/gaussaiorg/commit/3d94e714a9) contrib|src: Update hard coded seeds (#3791)
- [`c02a994489`](https://github.com/gaussaiorg/commit/c02a994489) bump nMinimumChainWork, defaultAssumeValid, checkpointData for mainnet and testnet (#3789)
- [`1d41fbd760`](https://github.com/gaussaiorg/commit/1d41fbd760) Update man pages (#3798)
- [`b3bbc00dbc`](https://github.com/gaussaiorg/commit/b3bbc00dbc) Merge #15730: rpc: Show scanning details in getwalletinfo (#3785)
- [`3ad4651db1`](https://github.com/gaussaiorg/commit/3ad4651db1) Call EraseObjectRequest as soon as an object is read from the stream (#3783)
- [`d8f8f174c0`](https://github.com/gaussaiorg/commit/d8f8f174c0) Avoid accessing pendingContributionVerifications from VerifyPendingContributions while ReceiveMessage is still doing its job (#3782)
- [`0814e6145d`](https://github.com/gaussaiorg/commit/0814e6145d) qt: Handle fonts of deleted widgets properly, streamline the flow in `GUIUtil::updateFonts` (#3772)
- [`e149740120`](https://github.com/gaussaiorg/commit/e149740120) qt: avoid auto-updating window width when it's in full screen or when it's maximized (#3771)
- [`78358a2a6d`](https://github.com/gaussaiorg/commit/78358a2a6d) qt: Do not show a check-mark for "Encrypt wallet" menu item (#3770)
- [`7b72e98092`](https://github.com/gaussaiorg/commit/7b72e98092) Fix IS-locks sync via `mempool` p2p command (#3766)
- [`9ceee5df20`](https://github.com/gaussaiorg/commit/9ceee5df20) qt: Fix --disable-wallet build and --disablewallet mode (#3762)
- [`62985c771b`](https://github.com/gaussaiorg/commit/62985c771b) depends: Update Qt download url. (#3756)
- [`717a41a572`](https://github.com/gaussaiorg/commit/717a41a572) qt: Make sure there is a valid theme set in the options (#3755)
- [`01a3435158`](https://github.com/gaussaiorg/commit/01a3435158) update public part of windows code signing certificate (#3749)
