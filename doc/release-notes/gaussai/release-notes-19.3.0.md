...
- `wipetxes`: New command for `gaussai-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/gaussaiorg/compare/v19.2.0...gaussaipay:v19.3.0).
