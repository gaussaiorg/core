# Fuzzing Gaussai Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Gaussai Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/gaussaiorg/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/gaussaiorg/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/gaussaiorg/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/gaussaiorg/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the Gaussai Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Gaussai Core more robust.
...
with certain assembly code from Gaussai Core's code. See [developer notes on sanitizers](https://github.com/gaussaiorg/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing Gaussai Core using afl++

## Quickstart guide

To quickly get started fuzzing Gaussai Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Gaussai Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Gaussai Core using [Honggfuzz](https://github.com/google/honggfuzz):
