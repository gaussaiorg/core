...
This document provides guidelines for internationalization of the Gaussai Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gaussai_en.ts` remains unchanged.
