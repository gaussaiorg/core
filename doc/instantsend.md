...
This mechanism has been integrated into Bitcore-Node-Gaussai which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gaussaipay/insight-api-gaussai#web-socket-api](https://github.com/gaussaipay/insight-api-gaussai#web-socket-api)
* API: [https://github.com/gaussaipay/insight-api-gaussai#instantsend-transactions](https://github.com/gaussaipay/insight-api-gaussai#instantsend-transactions)
