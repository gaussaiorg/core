# Support for Output Descriptors in Gaussai Core

Since Gaussai Core v0.17, there is support for Output Descriptors. This is a
...
existing Gaussai Core wallets, a convenience function `combo` is
...
All RPCs in Gaussai Core will include the checksum in their output. Only
