...
def get_label(pr_num):
    return requests.get(f'https://api.github.com/repos/gaussaipay/gaussai/pulls/{pr_num}').json()['head']['label']
...
def main():
    ...
    for conflict in conflictPrs:
        ...
        r = requests.get(f'https://api.github.com/repos/gaussaipay/gaussai/pulls/{this_pr_num}')
        ...
        r = requests.get(f'https://github.com/gaussaiorg/branches/pre_mergeable/{our_pr_label}...{get_label(this_pr_num)}')
